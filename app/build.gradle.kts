...
android {
    namespace = "id.ac.polbeng.nofiazuriatin.githubprofile"
    compileSdk = 35

    defaultConfig {
        applicationId = "id.ac.polbeng.nofiazuriatin.githubprofile"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"

        buildConfigField ("String", "ACCESS_TOKEN", "\"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\"")
