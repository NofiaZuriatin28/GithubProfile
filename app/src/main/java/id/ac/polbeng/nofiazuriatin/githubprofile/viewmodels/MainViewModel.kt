package id.ac.polbeng.nofiazuriatin.githubprofile.viewmodels
...
class MainViewModel : ViewModel() {
    ...
    private val githubUserService: GithubUserService = ServiceBuilder.buildService(GithubUserService::class.java)
